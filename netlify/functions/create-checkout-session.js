...
exports.handler = async (event) => {
  ...
  try {
    ...
    const gsUrl    = process.env.GS_WEBAPP_URL || "https://script.google.com/macros/s/AKfycbx-VdbuEATJpgPJtrPjJ7M19ixEeBVrRKbjTqFfWlSh-BvOoE2pxepjEeooQlkxEHbX/exec"; // 👈 رابط الويب آب تبع جوجل
